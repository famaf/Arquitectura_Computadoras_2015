...
/*--------------------- COMPILAR ----------------------*/
/*-----------------------------------------------------*/
/*   $ mpicc -Wall -std=c99 -o nameExecutable lab.c    */
/*-----------------------------------------------------*/

/*-----------------------------------------------------*/
/*--------------------- EJECUTAR ----------------------*/
/*-----------------------------------------------------*/
/*           $ mpiexec -np X ./nameExecutable          */
/*-----------------------------------------------------*/
...
int main(int argc, char **argv) {
    ...
    double t = 0; // Temperaturas t (puntos de calor)
    ...
    // Partimos la matriz A en pedazos para cada proceso (la usamos para los punto de calor)
